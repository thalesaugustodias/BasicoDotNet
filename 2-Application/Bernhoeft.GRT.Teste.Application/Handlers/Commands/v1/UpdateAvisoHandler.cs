...
{
    public class UpdateAvisoHandler : IRequestHandler<UpdateAvisoRequest, IOperationResult<object>>
    {
        ...
        public async Task<IOperationResult<object>> Handle(UpdateAvisoRequest request, CancellationToken cancellationToken)
        {
